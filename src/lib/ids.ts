...
// so ids sort by creation time (a stable ordering tiebreak) and collide with
// vanishing probability. Prefixed by kind so the log is self-describing:
// `ent_01J...` (an entry), `evt_01J...` (an event envelope).
