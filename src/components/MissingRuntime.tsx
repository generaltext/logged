...
export function MissingRuntime({ onTryDemo }: { onTryDemo: () => void }) {
  const appUrl =
    typeof window !== 'undefined' ? window.location.origin : 'https://logged.generaltext.org'
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <div className="leading-tight">
            <h1 className="text-lg font-bold tracking-wide" style={{ color: 'var(--accent)' }}>
              Logged
            </h1>
        ...
        <p className="-mt-1 text-xs" style={{ color: 'var(--muted)' }}>
          The demo loads a sample log locally in your browser. Nothing is saved to an account, and
